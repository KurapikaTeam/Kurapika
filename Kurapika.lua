...
usertext = '*\n ⧉  ⟞اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'CXRCX')..')'
status  = '\n *⧉  ⟞تم ترقيته مطور*'
...
if BRAND1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⧉  ⟞اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'CXRCX')..') \n ⧉  ⟞'..BRAND1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
keyboard.inline_keyboard = {
{
{text = 'BrAnD TeAm', url = "https://t.me/CXRCX"}
},
}
local msg_id = msg.id_/2097152/0.5
...
{
{text = 'Ch~Developer', url = "https://t.me/CXRCX"},
},
}
local msg_id = msg.id_/2097152/0.5
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *⧉  ⟞اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'CXRCX')..')'..'\n*⧉  ⟞تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
