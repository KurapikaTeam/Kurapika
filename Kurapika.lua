...
local UserName = (data.username_ or "kksili")
...
usertext = '*\n ◈︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'kksili')..')'
status  = '\n *◈︙تم ترقيته مطور*'
...
usertext = '\n *◈︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'kksili')..')'
status  = '\n*◈︙تم ترقيته مطور*'
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *◈︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'kksili')..') \n ◈︙'..Kurapika1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
send(msg.chat_id_,0," *◈︙العضو :* {["..data.first_name_.."](T.ME/kksili)}\n◈︙["..Kurapika_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *◈︙عذرا ↫* {["..data.first_name_.."](T.ME/kksili)}\n*◈︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_, '*◈︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'kksili')..') \n*◈︙تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *◈︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'kksili')..') \n*◈︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *◈︙العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'kksili')..')'
status  = '\n*◈︙تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *◈︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'kksili')..')'
status  = '\n*◈︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *◈︙اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *◈︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'kksili')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *◈︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'kksili')..')'..'\n*◈︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'kksili')..')'
local iduser = result.sender_user_id_
