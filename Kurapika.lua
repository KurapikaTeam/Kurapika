...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/KurapikaTeam/Files_Kurapika/master/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevBRANDW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevBRANDW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevBRANDW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevBRANDW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevBRANDW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@S_X_X_G")  
...
--------------------------------------------------------------------------------------------------------------
function SourceBRAND(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."BRAND1:List:Filter"..sl)
...
os.execute('wget https://raw.githubusercontent.com/KurapikaTeam/BRAND/master/Kurapika.lua')
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "كوربيكا")
...
keyboard.inline_keyboard = {
{
{text = 'BrAnD TeAm', url = "https://t.me/ooBooo"}
},
}
local msg_id = msg.id_/2097152/0.5
...
function start_function(extra, result, success)
if BRANDSudoBot(result.sender_user_id_) then
...
if BRANDSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*⧉ ⟞لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if DevBRANDW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/KurapikaTeam/Files_Kurapika/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/KurapikaTeam/Files_Kurapika/master/File_Bot/"..file)
if res == 200 then
...
{
{text = 'Ch~Developer', url = "https://t.me/ooBooo"},
},
}
local msg_id = msg.id_/2097152/0.5
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,BRAND)
local t = "\n*ツ قائمة الاعضاء* \n 𓍹ⵧⵧⵧⵧⵧⵧⵧ.•♫•♬•𝙆𝙍•♬•♫•.ⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
x = 0
...
if BRANDSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
{{text = '⓵⓪', callback_data="/help10"},{text = 'الاوامر الرئيسيه', callback_data="/help"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
{{text = '𝙆𝙪𝙧𝙖𝙥𝙞𝙖 𝙏𝙀𝘼𝙈', url="t.me/ooBooo"}},
{{text = 'مطور السورس', url="t.me/S_X_X_G"}},
}
...
zx = JSON.decode(zh)
t = "\n*⧉ ⟞قائمه الزخرفه* \nٴ⧉∫ٴ 𓍹ⵧⵧⵧⵧⵧⵧⵧ.•♫•♬•𝙆𝙍•♬•♫•.ⵧⵧⵧⵧⵧⵧⵧ𓍻ٴ⧉∫○ٴ \n"
i = 0
for k,v in pairs(zx.ok) do
i = i + 1
t = t..i.."-  "..v.." \n"
end
send(msg.chat_id_, msg.id_, t..'ٴ⧉∫ٴ 𓍹ⵧⵧⵧⵧⵧⵧⵧ.•♫•♬•𝙆𝙍•♬•♫•.ⵧⵧⵧⵧⵧⵧⵧ𓍻ٴ⧉∫○ٴ\n⧉ ⟞[𝙆𝙪𝙧𝙖𝙥𝙞𝙖 𝙏𝙀𝘼𝙈](t.me/ooBooo) ')
end
...
keyboard.inline_keyboard = {
{{text = '𝙆𝙪𝙧𝙖𝙥𝙞𝙖 𝙏𝙀𝘼𝙈.',url="t.me/ooBooo"}},
{{text = '- اضغط هنا للمسح.',callback_data=msg.sender_user_id_..":database:del"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'انجي' or text == 'hf' or text == 'مبرمج ال.سورس' or text == 'توام اتتتلعالمي' or text == 'روح العتتالمي' then
local Text =[[
TᎧᏥᎽᎧ 𖨬 🇰🇼
]]
keyboard = {} 
...
{
{text = 'TᎧᏥᎽᎧ 𖨬 🇰🇼', url = "https://t.me/EEEEE1K"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/EEEEE1K&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'روضي' or text == 'مطور السورس' or text == 'مبرمج السورس' then
local Text = [[
ᯓ『 Murtaza 』𓆃
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'Murtaza',url="t.me/S_X_X_G"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/S_X_X_G&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
