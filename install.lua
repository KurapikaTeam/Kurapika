...
local RunBot = io.open("Kurapika", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/Kurapika
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr Kurapika.lua
wget "https://raw.githubusercontent.com/KurapikaTeam/Kurapika/main/Kurapika.lua"
while(true) do
rm -fr ../.telegram-cli
./tg -s ./Kurapika.lua -p PROFILE --bot=$token
done
]])
RunBot:close()
...
while(true) do
rm -fr ../.telegram-cli
screen -S Kurapika -X kill
screen -S Kurapika ./Kurapika
done
]])
RunTs:close()
end
